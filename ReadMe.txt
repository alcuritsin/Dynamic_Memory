...
//TODO: 2021/02/19
Создать ветку "dynamic_templated_separated", и в этой ветке вынести функции в отдельные файлы.
...
//DONE: 2021/02/12
/*
Оптимизировать код. Чтобы, при работе с динамическими массивами, программа не расходовала лишнюю оперативную память. --DONE
*/
